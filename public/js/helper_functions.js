...
function getHexCodeFromClass(c) {
  ...
  if (c > 0 && c <= 24) { return "#ffff33"; }
  if (c > 24 && c <= 30) { return "#333399"; }
  if (c > 30 && c <= 40) { return "#993333"; }
  if (c > 40 && c <= 50) { return "#ffcc33"; }
  if (c > 50 && c <= 60) { return "#993399"; }
  if (c > 60 && c <= 70) { return "#33ccff"; }
  if (c > 70 && c <= 80) { return "#ff6633"; }
  if (c > 80 && c <= 90) { return "#66cc99"; }
  if (c > 90 && c <= 100) { return "#336633"; }
}
